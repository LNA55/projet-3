<?php include 'header.php'; ?>
      ...
      <div class="jumbotron">
        <div class="container">
          <h2>Ceci est mon site témoin</h2>
          <p>A la fin de la formation, ce style devra avoir un code propre et parfaitement commenté, afin que je puisse facilement me retrouver lorsque je ferai un prochain site. En gros, c'est ma Geek Bible Perso. </p>
          <p><a class="btn btn-primary btn-lg" role="button">Je commence &raquo;</a></p>
        </div>
      </div>
    ...
    </div>Cours sur JavaScript
    <p> Javascript n'a aucun rapport avec Java ! :-) C'est l'outil le plus utilisé au monde. Par défaut, ça va marcher sur à peu près toutes les pages web. Jquery fait une passerelle entre le comportement standard et celui de certains navigateurs qui affichent mal javascript. Pas besoin de creuser : il y a en ligne des librairies pour faire à peu près tout. 

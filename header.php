...
<head>
		...
		<link rel="stylesheet" href="stylesheet/style.css" type="text/css"> <!-- donc il faut avoir le fichier style.CSS dans un dossier stylesheet -->
	...
	<header>
      ...
      <!--/ autre version : la navbar-collapse 
		...
		<div class="mon-header"> 
			<h1 style="display:inline; padding:0; margin:0 5 0 0;"><a href="../index.php">Marque, logo, H1</a></h1>
